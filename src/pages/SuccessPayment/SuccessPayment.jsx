    ...
    return (
        <div className='w-11/12 lg:w-10/12 mx-auto max-w-screen-2xl pb-12 border-t pt-24 space-y-4 flex flex-col items-center justify-center'>
            <div className='max-w-[800px] w-full min-h-[200px] border rounded-md bg-green-50 p-8 text-center flex flex-col items-center justify-center gap-2 '>
                <span className='text-green-700'><FaCheckCircle size={48}></FaCheckCircle></span>
                <h2 className='text-2xl md:text-3xl font-bold text-green-700'>Payment success</h2>
...
{/* appointment info  */}
                    ...
                    <div className="flex w-full flex-col">
                        <div className="divider font-semibold text-base text-green-700">Appointment Details</div>
                    </div>
                ...
                <button onClick={handleBackToHome} className='btn mt-4 hover:bg-green-700 hover:text-white'>
                    Back to Home
                </button>
            </div>
        </div>
