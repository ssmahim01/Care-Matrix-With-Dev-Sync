      ...
      .then(res => {
        ...
        if (res.data.insertedId) {
          ...
          axiosSecure.patch(`/rewards/${user?.email}`, {decreasePoint})
            ...
            toast.success("Redeem activated for you next appointment booking.")
  ...
  return (
    <div className="lg:w-full w-11/12 mx-auto pb-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Points Summary */}
        <Card className={"p-4 bg-base-200 shadow-md border border-base-300"}>
          <CardHeader>
            <CardTitle
              className={
              ...
              <ul className="space-y-3">
                {availableRewards.rewards.map((reward) => (
                  ...
                  >
                      ...
                      <p className="font-normal">{reward.offer} <span>{reward.pointsRequired} points</span></p>
