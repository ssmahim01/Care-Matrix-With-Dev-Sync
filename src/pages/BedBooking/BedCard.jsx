      ...
      {isLoading ? (
        <div className="border rounded-lg shadow-lg p-4 flex flex-col items-center transition-transform duration-300 hover:scale-105">
          ...
          <div className="flex justify-between w-full space-x-2 my-1">
            <button className="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700"></button>

            <button className="border border-blue-600 text-blue-600 px-3 py-1 sm:px-4 sm:py-2 rounded-md hover:bg-blue-100 flex items-center justify-center text-sm sm:text-base w-full sm:w-auto"></button>
          </div>
        </div>
      ) : (
        <div className="border rounded-lg shadow-lg p-4 flex flex-col items-center transition-transform duration-300 hover:scale-105">
