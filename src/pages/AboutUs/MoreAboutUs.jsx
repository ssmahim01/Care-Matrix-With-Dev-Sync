      ...
      <div className="grid lg:grid-cols-2 gap-8 items-center">
        ...
        <div>
          ...
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 mt-4">
            We Are A Clinic, <span className="text-[#0E82FD]">Provide Excellence</span> In Personalized Care
          </h2>
          ...
          <div className="mt-6 flex items-center space-x-6">
            ...
            <div>
              <p className="text-gray-700">
                We welcome advances in learning and technology in an effort to achieve efficient and quality-driven patient care.
              </p>
              <p className="mt-4 text-gray-700">
                Together, our team of doctors bring a broad spectrum of experience and continually undertake professional
                development to stay updated on the latest in medical treatment.
              </p>
            </div>
          </div>

          {/* Learn More Button */}
          <Link to="#" className="mt-8 inline-flex items-center text-blue-700 font-medium hover:underline">
