...
const Hero = () => {
  return (
    <div className="w-full mx-auto bg-cover bg-center  bg-no-repeat" style={{
      ...
      <div className="lg:w-10/12  px-6 pt-20 pb-6  lg:pt-0 lg:py-6  flex flex-col lg:flex-row items-center justify-between lg:gap-12  mx-auto">
        {/* Left Content */}
        <motion.div
          ...
          <h2 className="md:text-4xl  text-3xl font-bold text-white/90">
