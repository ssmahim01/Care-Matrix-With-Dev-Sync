...
const OurService = () => {
    const services = [
        { id: 1, name: "Pharmacology", icon: <FaBriefcaseMedical />, tips:"Advancing drug research and development for better treatments" },
        { id: 2, name: "Orthopedic", icon: <FaMicroscope />, tips:"Expert care for bone, joint, and muscle health" },
        { id: 3, name: "Hematology", icon: <FaHeart /> ,tips:"Comprehensive blood disorder diagnosis and treatment" },
        { id: 4, name: "Plastic Surgery", icon: <FaUserMd />, tips:"Enhancing aesthetics and reconstructive care" },
        { id: 5, name: "Neurology", icon: <FaBrain /> ,tips:"Cutting-edge solutions for brain and nervous system disorders" },
        { id: 6, name: "Ophthalmology", icon: <FaEye /> , tips:"Innovative eye care for vision health"},
        { id: 7, name: "Dental Care", icon: <FaTooth /> ,tips:"Ensuring bright smiles with top-notch dental treatments" },
        { id: 8, name: "Cardiology", icon: <FaNotesMedical /> ,tips:"Heart health solutions from diagnosis to treatment" },
    ];
