...
const Chat = () => {
  return (
    <div className="bg-[#F2F4F5] p-5 md:p-8 w-full rounded-md max-w-[98rem] mx-auto">
     ...
     <div className="w-full md:w-[55%]">
        ...
        <h3 className="lg:text-3xl text-[1.4rem] font-bold flex gap-2 items-center text-gray-900 my-2">
          <span>Chat</span> <FaMessage className="text-teal-600 text-xl" /> <span>& Get Extra Facilities</span>
        </h3>
        <p className="text-gray-700 mb-4 font-medium">
          {" "}
          Connect with <span className="font-semibold">doctors</span>,{" "}
          <span className="font-semibold">receptionists</span>,{" "}
        ...
        <div className="flex flex-col items-center">
          <FaUserNurse className="lg:text-3xl text-2xl text-green-300" />
          <span className="text-sm mt-1">Receptionist</span>
        </div>
        <div className="flex flex-col items-center">
